...
class UpdatePSKU(View):
    ...
    def post(self, request):
        ...
        session_code = check_session(request)
        return HttpResponse(json.dumps({'UpdatePSKU': queryset}, cls=DjangoJSONEncoder), status=session_code,
                            content_type='application/json')
...
class UpdateTargetWD(View):
    ...
    def post(self, request):
        ...
        session_code = check_session(request)
        return HttpResponse(json.dumps({'UpdateTargetWD': queryset}, cls=DjangoJSONEncoder), status=session_code,
                            content_type='application/json')
