...
#     time_perd_type_code = models.CharField(db_column='TIME_PERD_TYPE_CODE', max_length=20)  # Field name made
#     lowercase.
...
#     company = models.CharField(db_column='COMPANY', max_length=50, blank=True, null=True)  # Field name made
#     lowercase.
